...
<header class="mdui-appbar mdui-appbar-fixed">
	<div class="mdui-toolbar mdui-color-theme">
		...
		<a href="./" class="mdui-typo-headline mdui-hidden-xs">ICS</a>
		<a href="./" class="mdui-typo-title">Home</a>
		...
		<a href="https://github.com/ReincarnationSorrow/ICS-website-code" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: '查看项目'}">
    ...
    <div class="mdui-list" mdui-collapse="{accordion: true}" style="margin-bottom: 76px;">
        <div class="mdui-collapse-item ">
			<div class="mdui-collapse-item-header mdui-list-item mdui-ripple">
			    ...
			    <div class="mdui-list-item-content">1</div>
			    <i class="mdui-collapse-item-arrow mdui-icon material-icons">keyboard_arrow_down</i>
			</div>
			<div class="mdui-collapse-item-body mdui-list">
				<a href="./icp" class="mdui-list-item mdui-ripple ">2</a>
				<a href="./ACG" class="mdui-list-item mdui-ripple ">3</a>
